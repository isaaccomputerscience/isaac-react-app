    ...
    termsAndConditions: {
      ...
      section: [
        ...
        [
          ...
          " 1.2. “Student(s)” refers to the individual(s) in Years 9, 10, or 11, studying at a statefunded school in England and whose project is being submitted by teachers to enter the Competition.",
          ...
          "1.5. “Prize” refers to the awards outlined on the Isaac Computer Science website, which may include a participation certificate, Amazon gift vouchers, industry tours, and other partner-sponsored rewards.",
          "1.6. “Finalist(s)” refers to the Student(s) selected to participate in the regional finals. ",
          "1.7. “Winner(s)” refers to the Student(s) who wins the Competition.",
        ],
        "Eligibility",
        [
        ...
        [
          ...
          [
            "3.1.1. Teachers must register their school and students on the Isaac Computer Science platform.",
            "3.1.2. Teacher creates group(s) on Isaac Computer Science connecting the accounts of the Student(s) that are making an entry.",
            "3.1.3. Student(s) work on a product concept or prototype demonstrating an IoE idea in the video format adhering to specified Entry requirements and Entry deadlines.",
          ...
          "3.2. All entries must be received by 4 pm on 17 March 2025. Any entries received after this will not be considered.",
        ...
        [
          ...
          [
            ...
            "A concise written summary of the project.",
          ...
          [
            ...
            "4.5.5. If using a PowerPoint presentation for the video, the Student(s) must record a voiceover.",
        ...
        [
          ...
          [
            ...
            ["Innovativeness of the concept", "Uniqueness of the idea"],

            "2. Practicality and Feasibility: (20 points)",
            ["Realistic implementation", "Technical feasibility"],
            "3. Impact on Society: (30 points)",
            ["Potential to improve lives globally", "Alignment with the theme"],
            "4. Presentation Quality: (30 points)",
            ["Clarity and organization", "Engagement and communication skills"],
          ],
          ...
          "5.3. Finalists will be invited to present their projects at one of the regional events in June 2025. The regional events may be held in Birmingham, Manchester and London. The location may be subject to change.",
          "5.4. Finalists judged to be the Winners of the competition will receive prizes on the day of the in-person final.",
          "5.5. If Student(s) are selected as Finalist(s), Teacher must confirm participation in the regional final within one week of notification. In the event of delayed response or inability to attend, We reserve the right to offer the place to an alternative entry.",
          "5.6. We will publish the names of the winning school(s) and project details on Our websites and social media.",
        ],
        "Regional finals",
        [
          "6.1. The regional finals will be one-day events consisting of presentations, talks and workshops from industry representatives, as well as final presentations of the IoE device concepts and prototypes from the Competition Finalists.",
          "6.2. Finalists of the Competition will be invited to a regional final at one of the available locations where they present a concept or prototype of their IoE device in person. Finalists will be required to submit a device presentation ahead of the final. The exact date(s) to be confirmed to Finalists later.",
          "6.3. The Winners will be decided on by a judging panel appointed by the Organiser and announced during the regional final event(s).",
          "6.4. The school of the Finalist(s) will be responsible for travel arrangements and will pay for transport to and from the regional final event the Student(s) was invited to. Provision may be available for those who find difficulties in reaching the final.",
        ...
        [
          ...
          [
            ...
            "• industry tours with partners such as Siemens and Arcadis",
            "• a Royal Albert Hall box for a show of your choice",
            "• Isaac Computer Science notebook and pen",
          ],
