...
export const mockEventBooking: DetailedEventBookingDTO = {
  bookingId: 1005,
  userBooked: {
    givenName: "Cancelled",
    familyName: "Teacher",
...
export const mockEvent: IsaacEventPageDTO = {
  ...
  date: 253399842000000,
  bookingDeadline: 253399755600000,
  location: {
    address: {
      addressLine1: "",
      addressLine2: "",
  ...
  results: [
    {
      ...
      numberOfConfirmedBookings: 195,
      numberOfReservedBookings: 5,
...
export const buildMockUserSummaryWithGroupMembership = (
  user: any,
  groupId: number,
  ...
  results: [
      ...
      contents: [
        {
          ...
          tags: ["circular_motion", "book", "physics", "physics_linking_concepts", "mechanics"],
          audience: [
            {
              stage: ["a_level"],
      ...
      contents: [
        {
          ...
          tags: ["maths", "book", "physics_skills_19", "algebra", "manipulation"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
      ...
      contents: [
        {
          ...
          tags: ["physics", "fields", "gravitational"],
          creationContext: {},
          level: 6,
          questionPartStates: [],
        },
        {
          ...
          tags: ["maths", "book", "maths_book_gcse", "algebra", "manipulation"],
          audience: [
            {
              stage: ["gcse"],
        ...
        },
        {
          ...
          tags: ["skills", "relationships", "phys_book_gcse", "book", "physics"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["practice_2"],
        ...
        },
        {
          ...
          tags: ["phys_book_gcse", "physics", "book"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["challenge_2"],
            },
            {
              stage: ["a_level"],
              difficulty: ["practice_2"],
        ...
        },
        {
          ...
          tags: ["phys_book_gcse", "physics", "thermal", "gases"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["practice_1"],
        ...
        },
        {
          ...
          tags: ["maths", "problem_solving", "algebra", "manipulation"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
        ...
        },
        {
          ...
          tags: ["resistors", "book", "physics", "electricity", "phys_book_step_up"],
          audience: [
            {
              stage: ["year_9"],
              difficulty: ["practice_1"],
        ...
        },
        {
          ...
          tags: ["phys_book_gcse", "book", "physics", "waves_particles", "nuclear"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["practice_1"],
    ...
    },
    {
      ...
      contents: [
        {
          ...
          tags: ["maths_book", "maths", "problem_solving", "integration", "calculus"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_2"],
        ...
        },
        {
          ...
          tags: ["maths", "problem_solving", "integration", "calculus"],
          audience: [
            {
              stage: ["further_a"],
              difficulty: ["challenge_1"],
      ...
      gameFilter: {
        ...
        fields: ["calculus"],
        topics: ["integration"],
        questionCategories: ["quick_quiz", "problem_solving", "book"],
      },
      ownerId: mockUser.id,
      tags: [],
      creationMethod: "FILTER",
      ...
      contents: [
        {
          ...
          tags: ["dynamics", "physics", "mechanics", "quick_quiz"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["practice_2"],
        ...
        },
        {
          ...
          tags: ["physics", "problem_solving", "mechanics", "oscillations"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["challenge_3"],
            },
          ],
          creationContext: {},
          level: 6,
        ...
        },
        {
          ...
          tags: ["dynamics", "phys_book_gcse", "book", "physics", "mechanics"],
          audience: [
            {
              stage: ["gcse"],
              difficulty: ["challenge_2"],
        ...
        },
        {
          ...
          tags: ["dynamics", "physics", "problem_solving", "mechanics"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["challenge_2"],
        ...
        },
        {
          ...
          tags: ["circular_motion", "physics", "problem_solving", "mechanics"],
          audience: [
            {
              stage: ["further_a"],
              difficulty: ["challenge_2"],
        ...
        },
        {
          ...
          tags: ["dynamics", "book", "physics", "physics_skills_19", "mechanics"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["challenge_1"],
        ...
        },
        {
          ...
          tags: ["materials", "book", "physics", "physics_skills_19", "mechanics"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
    ...
    },
    {
      ...
      contents: [
        {
          ...
          creationContext: {
            stage: ["gcse"],
            difficulty: ["practice_2", "challenge_2"],
          },
          level: 0,
          questionPartStates: [],
        },
        ...
        },
        {
          ...
          tags: ["chemistry", "chemistry_16", "stoichiometry", "book", "foundations"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
        ...
        },
        {
          ...
          tags: ["skills", "graphs", "book", "physics", "physics_skills_19"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["challenge_1"],
      ...
      gameFilter: {
        ...
        stages: ["gcse"],
        difficulties: ["practice_2", "challenge_2"],
        questionCategories: ["quick_quiz", "problem_solving", "book"],
      },
      ownerId: mockUser.id,
      tags: [],
      ...
      contents: [
        {
          ...
          tags: ["chemistry", "chemistry_16", "book", "foundations", "atomic_structure"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
        ...
        },
        {
          ...
          tags: ["chemistry", "problem_solving", "foundations", "atomic_structure"],
          audience: [
            {
              stage: ["a_level"],
              difficulty: ["practice_1"],
      ...
      contents: [
        {
          ...
          passMark: 75.0,
          state: "NOT_ATTEMPTED",
          questionPartStates: ["NOT_ATTEMPTED", "NOT_ATTEMPTED"],
        },
        {
          id: "phys19_a1_q2",
          contentType: "isaacQuestionPage",
          ...
          passMark: 75.0,
          state: "NOT_ATTEMPTED",
          questionPartStates: ["NOT_ATTEMPTED"],
        },
        {
          id: "phys19_a1_q3",
          contentType: "isaacQuestionPage",
    ...
    gameboard: {
      ...
      contents: [
        ...
        },
        {
          ...
          passMark: 75.0,
          state: "NOT_ATTEMPTED",
          questionPartStates: ["NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED"],
        },
      ],
      wildCard: {
        id: "sig_figs_wildcard",
    ...
    gameboard: {
      ...
      contents: [
        ...
        },
        {
          ...
          passMark: 75.0,
          state: "NOT_ATTEMPTED",
          questionPartStates: ["NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED"],
        },
        {
          id: "gcse_ch4_30_q16_es",
          contentType: "isaacQuestionPage",
        ...
        },
        {
          ...
          passMark: 75.0,
          state: "NOT_ATTEMPTED",
          questionPartStates: ["NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED", "NOT_ATTEMPTED"],
        },
        {
          id: "step_up_39_q9",
          contentType: "isaacQuestionPage",
...
export const mockQuizAssignments = [
  {
    ...
    quizSummary: {
      ...
      hiddenFromRoles: ["TEACHER", "STUDENT"],
    },
  },
  {
    id: 10,
  ...
  results: [
    {
      ...
      children: [],
      value:
        "Isaac provides a free topic-based learning plan for Yr 10-13 students working independently from home and for schools offering support.",
      tags: [newsPodTag],
      image: {
        type: "image",
        children: [],
    ...
    },
    {
      ...
      children: [],
      value:
        "These quizzes will help you to revise, rearrange equations, change units and practise extracting the correct information from a question.",
      tags: [newsPodTag, FEATURED_NEWS_TAG],
      image: {
        type: "image",
        children: [],
        published: false,
    ...
    },
    {
      ...
      children: [],
      value:
        "Order and explore our new books for GCSE Maths, pre-GCSE Physics, and linking concepts at A Level Physics.",
      tags: [newsPodTag],
      image: {
        type: "image",
        children: [],
