...
// NOTE: This is a Physics component that is not currently in use. May be used when Tutor role available
  ...
  return (
    <Container>
      ...
      <Row className="mb-3">
        <Col md={isDisabled ? 6 : undefined}>
          <p className="subtitle">
            Isaac Physics provides you with a huge range of resources to support your tutoring of Physics, Maths and
            Chemistry.
          </p>
        </Col>
        {isDisabled && (
          <Col md={6} className="text-center text-md-right">
            <Button
              ...
              size="lg"
              color="secondary"
              to={isLoggedIn(user) ? "/tutor_account_request" : "/register"}
            >
      ...
      <Row className="card-deck isaac-cards-body px-3">
        ...
        <IsaacCard
          doc={{
            ...
            image: { src: "/assets/teacher_features_sprite.svg#set-assignments" },
        ...
        <IsaacCard
          doc={{
            ...
            image: { src: "/assets/teacher_features_sprite.svg#track-progress" },
      ...
      <Row className="card-deck isaac-cards-body mb-5 mt-2 px-3">
        <IsaacCard
          doc={{
            clickUrl: "/support/tutor/general",
            image: { src: "/assets/teacher_features_sprite.svg#teacher-forum" },
            title: "Tutor FAQ",
            verticalContent: true,
        ...
        <IsaacCard
          doc={{
            ...
            image: { src: "/assets/teacher_features_sprite.svg#skills-book-cover" },
