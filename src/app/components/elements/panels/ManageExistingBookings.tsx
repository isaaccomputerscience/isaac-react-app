...
export const ManageExistingBookings = ({
  user,
  eventBookingId,
}: {
  user: PotentialUser;
  ...
  const userIdToSchoolMapping =
    useAppSelector(selectors.admin.userSchoolLookup) || {};
  ...
  let augmentedEventBookings = eventBookings.map(
    (booking: EventBookingDTO & { schoolName?: string }) => {
    ...
    <Accordion trustedTitle="Manage current bookings">
      {isEventLeader(user) && (
        <div className="bg-grey p-2 mb-3 text-center">
          As an event leader, you are only able to see the bookings of users who
          have granted you access to their data.
        </div>
      )}
              ...
              <thead>
                <tr>
                  ...
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection(
                        "userBooked.familyName",
                      )}
                    >
                      Name
                    </RS.Button>
                  ...
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("userBooked.email")}
                    >
                      Email
                    </RS.Button>
                  </th>
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("userBooked.role")}
                    >
                      Account type
                    </RS.Button>
                  </th>
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("schoolName")}
                    >
                      School
                    </RS.Button>
                  </th>
                  ...
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("bookingStatus")}
                    >
                      Booking status
                    </RS.Button>
                  </th>
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("bookingDate")}
                    >
                      Booking created
                    </RS.Button>
                  </th>
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("updated")}
                    >
                      Booking updated
                    </RS.Button>
                  </th>
                  ...
                  <th className="align-middle">
                    <RS.Button
                      color="link"
                      onClick={setSortPredicateAndDirection("reservedById")}
                    >
                      Reserved by ID
                    </RS.Button>
                  </th>
                    ...
                    return (
                      <tr key={booking.bookingId}>
                        <td className="align-middle">
                          {["WAITING_LIST", "CANCELLED"].includes(
                            ...
                            <RS.Button
                              ...
                              onClick={() =>
                                dispatch(
                                  promoteUserBooking(eventBookingId, userId),
                                )
                              }
                            >
                              Promote
                          ...
                          {["WAITING_LIST", "CONFIRMED"].includes(
                            booking.bookingStatus as string,
                          ) && (
                            <RS.Button
                              color="primary"
                              ...
                              onClick={() =>
                                dispatch(
                                  cancelUserBooking(eventBookingId, userId),
                                )
                              }
                            >
                              Cancel
                          ...
                          {isAdmin(user) && (
                            <RS.Button
                              ...
                              onClick={() =>
                                dispatch(
                                  deleteUserBooking(eventBookingId, userId),
                                )
                              }
                            >
                              Delete
                        ...
                        <td className="align-middle">
                          {booking.userBooked &&
                            (
                              booking.userBooked as UserSummaryWithEmailAddressDTO
                            ).email}
                        </td>
                        <td className="align-middle">
                          {booking.userBooked && booking.userBooked.role}
                        </td>
                        ...
                        <td className="align-middle">
                          {Array.from(
                            new Set(
                              booking.userBooked?.registeredContexts?.map(
                                (rc) => stageLabelMap[rc.stage!],
                              ),
                            ),
                          ).join(", ")}
                        </td>
                        <td className="align-middle">
                          {Array.from(
                            new Set(
                              booking.userBooked?.registeredContexts?.map(
                                (rc) => examBoardLabelMap[rc.examBoard!],
                              ),
                            ),
                          ).join(", ")}
                        </td>
                        ...
                        <td className="align-middle">
                          {booking.additionalInformation &&
                            booking.additionalInformation.experienceLevel}
                        </td>
                        <td className="align-middle">
                          {booking.additionalInformation &&
                            booking.additionalInformation
                        ...
                        <td className="align-middle">
                          {booking.additionalInformation &&
                            booking.additionalInformation.medicalRequirements}
                        </td>
                        <td className="align-middle">
                          {booking.additionalInformation &&
                            booking.additionalInformation.emergencyName}
                        </td>
                        <td className="align-middle">
                          {booking.additionalInformation &&
                            booking.additionalInformation.emergencyNumber}
                        </td>
                      </tr>
                    );
                  })}
                  ...
                  if (atLeastOne(usersWithStatus.length)) {
                    return (
                      <RS.DropdownItem
                        key={index}
                        onClick={() =>
                          dispatch(showGroupEmailModal(usersWithStatus))
                        }
                      >
      ...
      {zeroOrLess(eventBookings.length) && (
        <p className="text-center m-0">
          <strong>
            There aren&apos;t currently any bookings for this event.
          </strong>
        </p>
      )}
    </Accordion>
