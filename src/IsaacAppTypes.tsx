...
export type Action =
  ...
  | { type: ACTION_TYPE.ADMIN_MODIFY_TEACHER_PENDING_REQUEST }
  | { type: ACTION_TYPE.ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_SUCCESS; message: string }
  | { type: ACTION_TYPE.ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_FAILURE }
  ...
  | { type: ACTION_TYPE.QUESTION_RANDOM_QUESTIONS_REQUEST }
  | { type: ACTION_TYPE.QUESTION_RANDOM_QUESTIONS_RESPONSE_SUCCESS; randomQuestions: ApiTypes.IsaacQuestionPageDTO[] }
  | { type: ACTION_TYPE.QUESTION_RANDOM_QUESTIONS_RESPONSE_FAILURE }
  | {
  ...
  | {
      ...
      questionId: string;
      attempt: Immutable<ApiTypes.ChoiceDTO | ValidatedChoice<ApiTypes.ChoiceDTO>>;
    }
...
export const AssignmentProgressPageSettingsContext = React.createContext<PageSettings>({
  colourBlind: false,
