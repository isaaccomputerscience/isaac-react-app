...
export const IsaacTabs = (props: any) => {
  const {
    doc: { children: tabs, expandable },
  } = props as IsaacTabsProps;
  const [tabTitlesToContent, setTabTitlesToContent] =
    useState<IsaacTabChildren>({});
  ...
  return (
    <Tabs className="isaac-tab" tabContentClass="pt-4" expandable={expandable}>
      {tabTitlesToContent}
    </Tabs>
  );
};
