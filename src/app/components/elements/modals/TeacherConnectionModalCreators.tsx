...
export const tokenVerificationModal = (
  userId: number,
  authToken: string,
  usersToGrantAccess: UserSummaryWithEmailAddressDTO[],
) => {
  return {
    closeAction: () => {
    ...
    body: (
      <React.Fragment>
        <p>
          Are you sure you would like to give the following Isaac users access
          to your data?
        </p>
        <RS.Table bordered>
          <tbody>
        ...
        <p>
          <small>
            <strong>Remember</strong>: you can always revoke access to your data
            from the Teacher Connections tab on this page.
          </small>
          <br />
          <small>
    ...
    buttons: [
      ...
      <RS.Button
        ...
        color="secondary"
        onClick={() => {
          store.dispatch(authenticateWithToken(authToken));
        }}
      >
        Confirm
      </RS.Button>,
...
export const revocationConfirmationModal = (
  userId: number,
  userToRevoke: UserSummaryWithEmailAddressDTO,
) => {
  return {
    closeAction: () => {
      store.dispatch(closeActiveModal());
    ...
    body: (
      <React.Fragment>
        <p>
          The user <strong>{extractTeacherName(userToRevoke)}</strong> will no
          longer be able to access your data.
          <br />
    ...
    buttons: [
      ...
      <RS.Button
        ...
        color="secondary"
        onClick={() => {
          store.dispatch(revokeAuthorisation(userId, userToRevoke));
        }}
      >
        Confirm
      </RS.Button>,
...
export const releaseConfirmationModal = (
  userId: number,
  ...
  return {
    ...
    body: (
      <React.Fragment>
        <p>
          Are you sure you want to end your access to{" "}
          <strong>
            {otherUser.givenName} {otherUser.familyName}
          </strong>
          &apos;s data?
          <br />
          You will need to ask them to grant access again in the future if you
          change your mind.
        </p>
      </React.Fragment>
    ),
    buttons: [
      ...
      <RS.Button
        ...
        color="secondary"
        onClick={() => {
          store.dispatch(releaseAuthorisation(userId, otherUser));
        }}
      >
        Confirm
      </RS.Button>,
  ...
  return {
    ...
    buttons: [
      ...
      <RS.Button
        ...
        color="secondary"
        onClick={() => {
          store.dispatch(releaseAllAuthorisations(userId));
        }}
      >
        Confirm
      </RS.Button>,
