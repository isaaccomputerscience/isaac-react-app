...
import { isTutorOrAbove, SITE_SUBJECT_TITLE, validateEmail, WEBMASTER_EMAIL } from "../../services";
              ...
              {isTutorOrAbove(user) && (
                <Row>
                  <Col className="text-center pt-3">
                    <span className="h3">You already have a tutor or teacher account</span>
                  </Col>
                </Row>
              )}
              {!isTutorOrAbove(user) &&
                (messageSent && !errorMessage ? (
                  <Row>
                    <Col className="text-center">
                      <p className="mt-3">Thank you for submitting a tutor account request.</p>
                      <p>
