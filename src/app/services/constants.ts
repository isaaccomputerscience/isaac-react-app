...
export const SOCIAL_LINKS = {
  youtube: {
    name: "YouTube",
    href: "https://www.youtube.com/channel/UC-qoIYj8kgR8RZtQphrRBYQ",
  },
  ...
  instagram: {
    name: "Instagram",
    href: "https://www.instagram.com/isaaccompsci",
  },
};
...
export const API_REQUEST_FAILURE_MESSAGE =
  "There may be an error connecting to the Isaac platform.";
...
export const EMPTY_BOOLEAN_NOTATION_RECORD: {
  [bn in BOOLEAN_NOTATION]: false;
} & BooleanNotation = {
  [BOOLEAN_NOTATION.ENG]: false,
  [BOOLEAN_NOTATION.MATH]: false,
};
export const examBoardBooleanNotationMap: {
  [examBoard in ExamBoard]: BOOLEAN_NOTATION;
} = {
...
export const DIFFICULTY_ITEM_OPTIONS: { value: Difficulty; label: string }[] =
  difficultiesOrdered.map((d) => ({ value: d, label: difficultyLabelMap[d] }));
export const DIFFICULTY_ICON_ITEM_OPTIONS: {
  value: Difficulty;
  label: string;
}[] = difficultiesOrdered.map((d) => ({
  value: d,
...
export function isAQuestionLikeDoc(
  doc: ContentDTO,
): doc is IsaacQuestionPageDTO | IsaacFastTrackQuestionPageDTO {
  return (
    doc.type === DOCUMENT_TYPE.QUESTION ||
...
export const documentTypePathPrefix: {
  [documentType in DOCUMENT_TYPE]: string;
} = {
...
export const ASSIGNMENT_PROGRESS_CRUMB = {
  title: "My markbook",
  to: "/my_markbook",
};
