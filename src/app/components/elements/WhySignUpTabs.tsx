              ...
              <CardBody className="d-flex flex-column">
                ...
                <CardText className="mb-auto" tag="div">
                  ...
                  <ul>
                    ...
                    <li>
                      Access high-quality materials written by experienced
                      teachers
                    </li>
                    <li>Learn relevant content tailored to your exam board</li>
                  </ul>
                  <p>
                    Everything on Isaac Computer Science is free, funded by the
                    Department for Education.
                  </p>
                </CardText>
                <CardText className="mb-auto text-center">
                  <Button tag={Link} to="/register" color="secondary">
                    Sign Up
                  </Button>
                </CardText>
              </CardBody>
            ...
            <Card className="card-list py-3 px-4">
              <CardBody className="d-flex flex-column">
                ...
                <CardText className="mb-auto" tag="div">
                  ...
                  <ul>
                    <li>
                      Complete coverage of the leading exam specifications
                    </li>
                    <li>
                ...
                <CardText className="text-center">
                  <Button tag={Link} to="/teachers" color="secondary">
