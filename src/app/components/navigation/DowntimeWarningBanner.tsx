...
export const DowntimeWarningBanner = () => {
  ...
  const inDateRange =
    new Date(1626854400000) <= new Date() &&
    new Date() <= new Date(1627056000000);
      ...
      <Alert color="danger" className="mb-0">
        <RS.Container>
          <RS.Row style={{ alignItems: "center" }}>
            <RS.Col xs={12} md={9}>
              <span>
                Please note Isaac {SITE_SUBJECT_TITLE} will be unavailable for
                an hour at 5pm BST on Friday 23<sup>rd</sup> July for essential
                maintenance. You will need to log in again once the maintenance
                is complete.
                <br />
                <a
