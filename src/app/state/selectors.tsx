...
export const selectors = {
  ...
  toasts: {
    toasts: createSelector([(state: AppState) => state?.toasts || []], (toasts) => toasts),
  },

  topic: {
    currentTopic: createSelector([(state: AppState) => state?.currentTopic], (currentTopic) => {
  ...
  questions: {
    ...
    anyQuestionPreviouslyAttempted: createSelector([(state: AppState) => state?.questions?.questions], (questions) => {
  ...
  teacher: {
    userProgress: (state: AppState) =>
      state?.userProgress && anonymiseIfNeededWith(anonymisationFunctions.userProgress)(state.userProgress),
  ...
  connections: {
    activeAuthorisations: (state: AppState) =>
      ...
      anonymiseIfNeededWith(anonymisationFunctions.activeAuthorisations)(state?.activeAuthorisations),
    otherUserAuthorisations: (state: AppState) =>
      state?.otherUserAuthorisations &&
      anonymiseIfNeededWith(anonymisationFunctions.otherUserAuthorisations)(state?.otherUserAuthorisations),
    groupMemberships: (state: AppState) =>
      state?.groupMemberships &&
      anonymiseListIfNeededWith(anonymisationFunctions.groupMembershipDetail)(state?.groupMemberships),
  },
  ...
  quizzes: {
    ...
    assignment: (state: AppState) =>
      state?.quizAssignment && anonymiseIfNeededWith(anonymisationFunctions.assignment)(state.quizAssignment),
