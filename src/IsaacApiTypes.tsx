...
export interface IsaacSymbolicLogicQuestionDTO
  extends IsaacSymbolicQuestionDTO {}
...
export interface FormulaValidationResponseDTO
  extends QuestionValidationResponseDTO {
...
export interface QuantityValidationResponseDTO
  extends QuestionValidationResponseDTO {
...
export interface ItemValidationResponseDTO
  extends QuestionValidationResponseDTO {
...
export interface AnonymousUserDTO extends AbstractSegueUserDTO {
  sessionId?: string;
  temporaryQuestionAttempts?: {
    [index: string]: { [index: string]: QuestionValidationResponseDTO[] };
  };
  dateCreated?: Date;
  lastUpdated?: Date;
}
...
export interface UserSummaryForAdminUsersDTO
  extends UserSummaryWithEmailAddressDTO {
  lastUpdated?: Date;
  lastSeen?: Date;
  registrationDate?: Date;
  schoolId?: string;
...
export type GameboardItemState =
  | "PERFECT"
  | "PASSED"
  | "IN_PROGRESS"
  | "NOT_ATTEMPTED"
