            ...
            {atLeastOne(eventOverviews.length) && (
              <div className="overflow-auto">
                <RS.Table bordered className="mb-0 bg-white">
                  ...
                  <tbody>
                    {eventOverviews.sort(sortOnPredicateAndReverse(sortPredicate, reverse)).map((event) => (
                      <tr key={event.id}>
                        <td className="align-middle">
                          <RS.Button
                            ...
                            outline
                            className="btn-sm"
                            onClick={() => setSelectedEventId(event.id as string)}
                          >
                            Manage
                          </RS.Button>
                        </td>
                        ...
                        <td className="align-middle">
                          {event.location && event.location.address && event.location.address.town}
                        </td>
