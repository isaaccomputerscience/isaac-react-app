...
export const Routes = [
  ...
  <Redirect
    key={key++}
    from="/assignment_progress/:assignmentId"
    to="/my_markbook/:assignmentId"
  />,

  // Topics
  <Redirect
    key={key++}
    from="/topics/procedural_and_structured_programming"
    to="/topics/procedural_programming"
  />,
  <Redirect
    key={key++}
    from="/topics/guis"
    to="/topics/event_driven_programming"
  />,
  <Redirect
    key={key++}
    from="/topics/searching_sorting_pathfinding"
    to="/topics/searching"
  />,
  <Redirect
    key={key++}
    from="/topics/theory_of_computation"
    to="/topics/models_of_computation"
  />,
  <Redirect
    key={key++}
    from="/topics/operating_systems_and_software"
    to="/topics/operating_systems"
  />,
  <Redirect
    key={key++}
    from="/topics/number_bases"
    to="/topics/number_representation"
  />,
  <Redirect
    key={key++}
    from="/topics/string_manipulation"
    to="/topics/string_handling"
  />,
  ...
  <StaticPageRoute
    ...
    exact
    path="/safeguarding"
    pageId="events_safeguarding"
  />,
  <StaticPageRoute
    key={key++}
    exact
    path="/teaching_order"
    pageId="teaching_order"
  />,
  <StaticPageRoute
    key={key++}
    exact
    path="/teachcomputing"
    pageId="teach_computing"
  />,
