        ...
        <RS.CardBody>
          ...
          <div>
              ...
              <RS.Col md={6}>
                ...
                <RS.Input
                  ...
                  value={
                    Array.from(
                      new Set(
                        targetUser.registeredContexts?.map(
            ...
            <RS.Row>
              <RS.Col>
                {editingSelf &&
                  targetUser.emailVerificationStatus != "VERIFIED" &&
                ...
                {targetUser.emailVerificationStatus != "VERIFIED" &&
                  verifyEmailRequestSent && (
                    <span>
                      We have sent an email to {targetUser.email}. Please follow
                      the instructions in the email prior to booking.
                    </span>
                  )}
              </RS.Col>
            </RS.Row>
        ...
        <RS.CardBody>
          ...
          <div>
            {targetUser.role != "STUDENT" && (
              <React.Fragment>
                <RS.Label htmlFor="job-title" className="form-required">
                  Job title
                </RS.Label>
                <RS.Input
                  id="job-title"
                  name="job-title"
                  type="text"
                  value={additionalInformation.jobTitle || ""}
                  onChange={(event) =>
                    updateAdditionalInformation({
            ...
            {targetUser.role == "STUDENT" && (
              <React.Fragment>
                ...
                {(event.isATeacherEvent ||
                  additionalInformation.yearGroup == "TEACHER") && (
          ...
          {!event.isVirtual && (
            <div>
              <div>
                <RS.Label htmlFor="medical-reqs">
                  ...
                  <RS.UncontrolledPopover
                    trigger="click"
                    placement="bottom"
                    target="dietary-reqs-help"
                  >
                    <RS.PopoverBody>
                      For example, it is important for us to know if you have a
                      severe allergy and/or carry an EpiPen, are prone to
                      fainting, suffer from epilepsy...
                    </RS.PopoverBody>
                  </RS.UncontrolledPopover>
                </RS.Label>
                <RS.Input
                  ...
                  name="medical-reqs"
                  type="text"
                  value={additionalInformation.medicalRequirements || ""}
                  onChange={(event) =>
                    updateAdditionalInformation({
                      medicalRequirements: event.target.value,
                    })
                  }
                />
              </div>
              ...
              <div>
                <RS.Label htmlFor="access-reqs">
                  ...
                  <RS.UncontrolledPopover
                    trigger="click"
                    placement="bottom"
                    target="access-reqs-help"
                  >
                    <RS.PopoverBody>
                      For example, please let us know if you need wheelchair
                      access, hearing loop or if we can help with any special
                      adjustments.
                    </RS.PopoverBody>
                  </RS.UncontrolledPopover>
                </RS.Label>
                <RS.Input
                  ...
                  name="access-reqs"
                  type="text"
                  value={additionalInformation.accessibilityRequirements || ""}
                  onChange={(event) =>
                    updateAdditionalInformation({
              ...
              {additionalInformation.yearGroup != "TEACHER" &&
                additionalInformation.yearGroup != "OTHER" && (
                  <RS.Row>
                    <RS.Col xs={12}>
                    ...
                    <RS.Col md={6}>
                      ...
                      <RS.Input
                        ...
                        name="emergency-name"
                        type="text"
                        value={additionalInformation.emergencyName || ""}
                        onChange={(event) =>
                          updateAdditionalInformation({
                    ...
                    <RS.Col md={6}>
                      ...
                      <RS.Input
                        ...
                        type="text"
                        value={additionalInformation.emergencyNumber || ""}
                        onChange={(event) =>
                          updateAdditionalInformation({
          ...
          {targetUser.role != "STUDENT" && (
            <React.Fragment>
              <RS.Label htmlFor="experience-level">
              ...
              <RS.Input
                ...
                type="text"
                value={additionalInformation.experienceLevel || ""}
                onChange={(event) =>
                  updateAdditionalInformation({
