...
export type Action =
  ...
  | {
      ...
      user: Immutable<ApiTypes.RegisteredUserDTO>;
    }
  ...
  | {
      ...
      userAuthSettings: ApiTypes.UserAuthenticationSettingsDTO;
    }
  | {
  ...
  | {
      ...
      selectedUserAuthSettings: ApiTypes.UserAuthenticationSettingsDTO;
    }
  | {
  ...
  | {
      ...
      provider: ApiTypes.AuthenticationProvider;
    }
  | {
  ...
  | {
      type: ACTION_TYPE.USER_PASSWORD_RESET_RESPONSE_FAILURE;
      errorMessage: string;
    }
  ...
  | {
      ...
      users: UserSummaryForAdminUsersDTO[];
    }
  ...
  | {
      ...
      getUsers: Immutable<RegisteredUserDTO>;
    }
  ...
  | {
      ...
      authorisations: ApiTypes.UserSummaryWithEmailAddressDTO[];
    }
  ...
  | {
      ...
      otherUserAuthorisations: ApiTypes.UserSummaryDTO[];
    }
  ...
  | {
      ...
      groupMemberships: GroupMembershipDetailDTO[];
    }
  | { type: ACTION_TYPE.GROUP_GET_MEMBERSHIPS_RESPONSE_FAILURE }
  | { type: ACTION_TYPE.GROUP_CHANGE_MEMBERSHIP_STATUS_REQUEST }
  | {
      type: ACTION_TYPE.GROUP_CHANGE_MEMBERSHIP_STATUS_RESPONSE_SUCCESS;
      groupId: number;
      newStatus: MEMBERSHIP_STATUS;
    }
  ...
  | {
      ...
      terms: ApiTypes.GlossaryTermDTO[];
    }
  ...
  | {
      ...
      questionId: string;
      attempt: Immutable<ApiTypes.ChoiceDTO>;
    }
  | {
  ...
  | {
      ...
      questionId: string;
      attempt: Immutable<
        ApiTypes.ChoiceDTO | ValidatedChoice<ApiTypes.ChoiceDTO>
      >;
    }
  | { type: ACTION_TYPE.QUESTION_SEARCH_REQUEST }
  | {
      type: ACTION_TYPE.QUESTION_SEARCH_RESPONSE_SUCCESS;
      questions: ApiTypes.ContentSummaryDTO[];
    }
  ...
  | {
      ...
      userAnsweredQuestionsByDate: ApiTypes.AnsweredQuestionsByDate;
    }
  ...
  | {
      ...
      topic: ApiTypes.IsaacTopicSummaryPageDTO;
    }
  ...
  | {
      type: ACTION_TYPE.SEARCH_REQUEST;
      query: string;
      types: string | undefined;
    }
  | {
      type: ACTION_TYPE.SEARCH_RESPONSE_SUCCESS;
      searchResults: ApiTypes.ResultsWrapper<ApiTypes.ContentSummaryDTO>;
    }
  ...
  | {
      ...
      eventBookings: ApiTypes.EventBookingDTO[];
    }
  ...
  | {
      ...
      eventBookingsForGroup: ApiTypes.EventBookingDTO[];
    }
  ...
  | {
      ...
      concepts: FasttrackConceptsState;
    }
  | { type: ACTION_TYPE.QUIZZES_REQUEST }
  | { type: ACTION_TYPE.QUIZZES_RESPONSE_FAILURE }
  | {
      type: ACTION_TYPE.QUIZZES_RESPONSE_SUCCESS;
      quizzes: ApiTypes.ResultsWrapper<ApiTypes.ContentSummaryDTO>;
    }
  | {
      type: ACTION_TYPE.QUIZ_SET_REQUEST;
      assignment: ApiTypes.QuizAssignmentDTO;
    }
  | {
      type: ACTION_TYPE.QUIZ_SET_RESPONSE_SUCCESS;
      newAssignment: ApiTypes.QuizAssignmentDTO;
    }
  | { type: ACTION_TYPE.QUIZ_ASSIGNMENTS_REQUEST }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNMENTS_RESPONSE_SUCCESS;
      assignments: ApiTypes.QuizAssignmentDTO[];
    }
  | { type: ACTION_TYPE.QUIZ_ASSIGNMENTS_RESPONSE_FAILURE }
  | { type: ACTION_TYPE.QUIZ_ASSIGNED_TO_ME_REQUEST }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNED_TO_ME_RESPONSE_SUCCESS;
      assignments: ApiTypes.QuizAssignmentDTO[];
    }
  | { type: ACTION_TYPE.QUIZ_ASSIGNED_TO_ME_RESPONSE_FAILURE }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_ASSIGNMENT_ATTEMPT_REQUEST;
      quizAssignmentId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_ATTEMPT_FEEDBACK_REQUEST;
      quizAttemptId: number;
    }
  | { type: ACTION_TYPE.QUIZ_START_FREE_ATTEMPT_REQUEST; quizId: string }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_ATTEMPT_RESPONSE_SUCCESS;
      attempt: ApiTypes.QuizAttemptDTO;
    }
  | { type: ACTION_TYPE.QUIZ_LOAD_ATTEMPT_RESPONSE_FAILURE; error: string }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_STUDENT_ATTEMPT_FEEDBACK_REQUEST;
      quizAttemptId: number;
      userId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_STUDENT_ATTEMPT_FEEDBACK_RESPONSE_SUCCESS;
      studentAttempt: ApiTypes.QuizAttemptFeedbackDTO;
    }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_STUDENT_ATTEMPT_FEEDBACK_RESPONSE_FAILURE;
      error: string;
    }
  | {
      type: ACTION_TYPE.QUIZ_ATTEMPT_MARK_COMPLETE_REQUEST;
      quizAttemptId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_ATTEMPT_MARK_COMPLETE_RESPONSE_SUCCESS;
      attempt: ApiTypes.QuizAttemptDTO;
    }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNMENT_FEEDBACK_REQUEST;
      quizAssignmentId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNMENT_FEEDBACK_RESPONSE_SUCCESS;
      assignment: ApiTypes.QuizAssignmentDTO;
    }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNMENT_FEEDBACK_RESPONSE_FAILURE;
      error: string;
    }
  | {
      type: ACTION_TYPE.QUIZ_CANCEL_ASSIGNMENT_REQUEST;
      quizAssignmentId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_CANCEL_ASSIGNMENT_RESPONSE_SUCCESS;
      quizAssignmentId: number;
    }
  | {
      type: ACTION_TYPE.QUIZ_CANCEL_ASSIGNMENT_RESPONSE_FAILURE;
      quizAssignmentId: number;
    }
  | { type: ACTION_TYPE.QUIZ_LOAD_PREVIEW_REQUEST; quizId: string }
  | {
      type: ACTION_TYPE.QUIZ_LOAD_PREVIEW_RESPONSE_SUCCESS;
      quiz: ApiTypes.IsaacQuizDTO;
    }
  | { type: ACTION_TYPE.QUIZ_LOAD_PREVIEW_RESPONSE_FAILURE; error: string }
  | { type: ACTION_TYPE.QUIZ_ATTEMPTED_FREELY_BY_ME_REQUEST }
  | {
      type: ACTION_TYPE.QUIZ_ATTEMPTED_FREELY_BY_ME_RESPONSE_SUCCESS;
      attempts: ApiTypes.QuizAttemptDTO[];
    }
  | { type: ACTION_TYPE.QUIZ_ATTEMPTED_FREELY_BY_ME_RESPONSE_FAILURE }
  | { type: ACTION_TYPE.QUIZ_ATTEMPT_MARK_INCOMPLETE_REQUEST }
  | {
      type: ACTION_TYPE.QUIZ_ATTEMPT_MARK_INCOMPLETE_RESPONSE_SUCCESS;
      quizAssignmentId: number;
      feedback: ApiTypes.QuizUserFeedbackDTO;
    }
  | { type: ACTION_TYPE.QUIZ_ASSIGNMENT_UPDATE_REQUEST }
  | {
      type: ACTION_TYPE.QUIZ_ASSIGNMENT_UPDATE_RESPONSE_SUCCESS;
      quizAssignmentId: number;
      update: ApiTypes.QuizAssignmentDTO;
    };
...
export interface IsaacQuestionProps<
  T extends QuestionDTO,
  R extends QuestionValidationResponseDTO = QuestionValidationResponseDTO,
> {
  doc: T;
  questionId: string;
  readonly?: boolean;
...
export interface AppGroupMembership
  extends ApiTypes.UserSummaryWithGroupMembershipDTO {
...
export function isValidatedChoice(
  choice: Immutable<ApiTypes.ChoiceDTO | ValidatedChoice<ApiTypes.ChoiceDTO>>,
): choice is Immutable<ValidatedChoice<ApiTypes.ChoiceDTO>> {
...
export type PotentialUser =
  | LoggedInUser
  | { loggedIn: false; requesting?: boolean };

export interface ValidationUser extends ApiTypes.RegisteredUserDTO {
  password: string | null;
}
export type LoggedInValidationUser =
  | (ValidationUser & { loggedIn: true })
  | { loggedIn: false };
...
export interface FigureNumbersById {
...
export const AccordionSectionContext = React.createContext<{
  ...
  id: undefined,
  clientId: "unknown",
  open: /* null is a meaningful default state for IsaacVideo */ null,
});
export const QuestionContext = React.createContext<string | undefined>(
  undefined,
);
export const ClozeDropRegionContext = React.createContext<
  | {
      ...
      dropZoneValidationMap: {
        [p: string]: { correct?: boolean; itemId?: string } | undefined;
      };
      shouldGetFocus: (id: string) => boolean;
    }
  | undefined
>(undefined);
export const QuizAttemptContext = React.createContext<{
  quizAttempt: QuizAttemptDTO | null;
  questionNumbers: { [questionId: string]: number };
}>({ quizAttempt: null, questionNumbers: {} });
export const ExpandableParentContext = React.createContext<boolean>(false);
export const ConfidenceContext = React.createContext<{
  recordConfidence: boolean;
}>({ recordConfidence: false });
export const AssignmentProgressPageSettingsContext =
  React.createContext<PageSettings>({
    colourBlind: false,
    formatAsPercentage: false,
    setColourBlind: () => {},
    setFormatAsPercentage: () => {},
    isTeacher: false,
  });
export const GameboardContext = React.createContext<GameboardDTO | undefined>(
  undefined,
);
...
export interface UserSchoolLookup {
  [userId: number]: School;
}
...
export interface UserProgress {
  ...
  attemptsByStageAndDifficulty?: {
    [stage: string]: { [difficulty: string]: number };
  };
  correctByStageAndDifficulty?: {
    [stage: string]: { [difficulty: string]: number };
  };
  userSnapshot?: UserSnapshot;
...
export type FasttrackConceptsState = {
  gameboardId: string;
  concept: string;
  items: GameboardItem[];
} | null;
...
export const QuizFeedbackModes: QuizFeedbackMode[] = [
  "NONE",
  "OVERALL_MARK",
  "SECTION_MARKS",
  "DETAILED_FEEDBACK",
