...
//       <ListGroupItem className="footer-bottom-links d-flex flex-row pt-lg-3 bg-transparent link-group w-100">
//         <h2 className="h5-bottom">Links</h2>
//         <ListGroup className="d-flex flex-row list-link-item">{footerLinks.right}</ListGroup>
//       </ListGroupItem>
...
export const ListGroupFooterBottom = () => (
  <div className="footer-links footer-bottom d-flex flex-wrap justify-content-between">
    <ListGroupItem className="footer-bottom-links d-flex flex-row pt-lg-3 bg-transparent link-group w-100">
      <h2 className="h5-bottom">Links</h2>
      <ListGroup className="d-flex flex-row list-link-item">{footerLinks.right}</ListGroup>
    </ListGroupItem>
    ...
    <div className="footer-logos">
      ...
      <ExternalLink href="https://www.gov.uk/government/organisations/department-for-education">
        <img src="/assets/logos/dfe.svg" alt="UK Department for Education" className="footer-logo" />
      </ExternalLink>
      <ExternalLink href="https://www.stem.org.uk/">
        <img src="/assets/logos/stem_footer.svg" alt="STEM Learning" className="footer-logo" />
      </ExternalLink>
    </div>
  </div>
);
