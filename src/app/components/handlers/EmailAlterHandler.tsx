...
export const EmailAlterHandler = () => {
  ...
  const errorMessage = useAppSelector(
    (state: AppState) => state && state.error,
  );
  ...
  const emailVerified =
    user && user.loggedIn && user.emailVerificationStatus === "VERIFIED";
  ...
  return (
    <Container id="email-verification">
              ...
              {!emailVerificationSuccess && errorMessage && (
                <React.Fragment>
                  ...
                  {idsMatch ? (
                    ...
                    <p>
                      Please login to your <Link to="/account">account</Link> to
