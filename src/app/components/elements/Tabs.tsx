...
type StringOrTabFunction =
  | string
  | ((tabTitle: string, tabIndex: number) => string);
...
function callOrString(
  stringOrTabFunction: StringOrTabFunction,
  tabTitle: string,
  tabIndex: number,
) {
...
export const Tabs = (props: TabsProps) => {
  ...
  return (
    <div
      className={classNames({ "mt-4": isDefined(expandButton) }, outerClasses)}
      ref={updateExpandRef}
    >
      {expandButton}
