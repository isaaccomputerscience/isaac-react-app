        ...
        <Col md={6}>
          <FormGroup>
            <Label
              ...
              htmlFor="programming-language-select"
            >
            ...
            <Input
              ...
              value={Object.values(PROGRAMMING_LANGUAGE).reduce(
                (val: string | undefined, key) =>
                  programmingLanguage?.[key as keyof ProgrammingLanguage]
                    ? key
                    : val,
                PROGRAMMING_LANGUAGE.NONE,
              )}
              onChange={(event: ChangeEvent<HTMLInputElement>) => {
                let newProgrammingLanguage = Object.entries(
                  programmingLanguage ?? {},
                ).reduce((acc, [k, v]) => ({ ...acc, [k]: false }), {});
                setProgrammingLanguage(
                  event.target.value
                    ? {
