...
export const AdminStats = () => {
  ...
  const adminStats = useAppSelector(
    (state: AppState) => state?.adminStats || null,
  );
  ...
  return (
    <RS.Container id="admin-stats-page">
      <TitleAndBreadcrumb
        currentPageTitle="Isaac statistics"
      ...
      <ShowLoading until={adminStats}>
        {adminStats && (
          <React.Fragment>
            <div className="py-3">
              A high-level overview of the users and activity on the platform:
            </div>
                  ...
                  <RS.Col>
                    ...
                    <ul className="list-unstyled mb-5">
                      <li>
                        ...
                        <strong>
                          {(
                            adminStats.activeUsersOverPrevious.SIX_MONTHS
                              .TOTAL || 0
                          ).toLocaleString()}
                        </strong>
                      </li>
                      <li>
                        ...
                        <strong>
                          {(
                            adminStats.activeUsersOverPrevious.TWO_YEARS
                              .TOTAL || 0
                          ).toLocaleString()}
                        </strong>
                      </li>
                      <li>
                        Total accounts:{" "}
                        <strong>
                          {(adminStats.userGenders.TOTAL || 0).toLocaleString()}
                        </strong>
                      </li>
                      <li className="mt-3">
                        ...
                        <ul className="list-unstyled">
                          <li>
                            ...
                            {asPercentage(
                              adminStats.userGenders.MALE,
                              adminStats.userGenders.TOTAL,
                            )}
                            %)
                          </li>
                          <li>
                          ...
                          <li>
                            Prefer not to say:{" "}
                            {adminStats.userGenders.PREFER_NOT_TO_SAY || 0} (
                            {asPercentage(
                              adminStats.userGenders.PREFER_NOT_TO_SAY,
                              adminStats.userGenders.TOTAL,
                            )}
                            %)
                          </li>
                          <li>
                            ...
                            (
                            {asPercentage(
                              adminStats.userGenders.UNKNOWN,
                              adminStats.userGenders.TOTAL,
                            )}
                            %)
                          </li>
                      ...
                      <li className="mt-3">
                        ...
                        <ul className="list-unstyled">
                          ...
                          <li>
                            Event Leader:{" "}
                            {adminStats.userRoles.EVENT_LEADER || 0}
                          </li>
                          <li>
                            Content Editor:{" "}
                            {adminStats.userRoles.CONTENT_EDITOR || 0}
                          </li>
                          <li>
                            Event Manager:{" "}
                            {adminStats.userRoles.EVENT_MANAGER || 0}
                          </li>
                      ...
                      <li className="mt-3">
                        ...
                        <ul className="list-unstyled">
                          <li>
                            ...
                            {(adminStats.userSchoolInfo.PROVIDED || 0) +
                              (adminStats.userSchoolInfo.BOTH_PROVIDED || 0)}
                          </li>
                          <li>
                            Other school provided:{" "}
                            {adminStats.userSchoolInfo.OTHER_PROVIDED || 0}
                          </li>
                          <li>
                            No school provided:{" "}
                            {adminStats.userSchoolInfo.NOT_PROVIDED || 0}
                          </li>
                        </ul>
                      </li>
                    </ul>
                    ...
                    <ul className="list-unstyled">
                      <li>
                        Question Page Views:{" "}
                        {(adminStats.viewQuestionEvents || 0).toLocaleString()}
                      </li>
                      <li>
                        Total Question Attempts:{" "}
                        {(
                          adminStats.answeredQuestionEvents || 0
                        ).toLocaleString()}
                      </li>
                      <li>
                        Concept Page Views:{" "}
                        {(adminStats.viewConceptEvents || 0).toLocaleString()}
                      </li>
                    </ul>
                  </RS.Col>
                  <RS.Col>
                    ...
                    <ul className="list-unstyled">
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.activeUsersOverPrevious.SEVEN_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.activeUsersOverPrevious.THIRTY_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.activeUsersOverPrevious.NINETY_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
                    ...
                    <ul className="list-unstyled">
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.answeringUsersOverPrevious.SEVEN_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.answeringUsersOverPrevious.THIRTY_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            All:{" "}
                            {adminStats.answeringUsersOverPrevious.NINETY_DAYS
                              .TOTAL || 0}
                          </li>
                          <li>
                            Teachers:{" "}
