...
export const QUESTION_ATTEMPT_THROTTLED_MESSAGE =
  "You have made too many attempts at this question. Please try again later!";
...
export enum ACTION_TYPE {
  ...
  USER_REGISTRATION_RESPONSE_SUCCESS = "USER_REGISTRATION_RESPONSE_SUCCESS",
  USER_REGISTRATION_RESPONSE_FAILURE = "USER_REGISTRATION_RESPONSE_FAILURE",
  ...
  USER_PRIVACY_POLICY_UPDATE_REQUEST = "USER_PRIVACY_POLICY_UPDATE_REQUEST",
  USER_PRIVACY_POLICY_UPDATE_RESPONSE_SUCCESS = "USER_PRIVACY_POLICY_UPDATE_RESPONSE_SUCCESS",
  USER_PRIVACY_POLICY_UPDATE_RESPONSE_FAILURE = "USER_PRIVACY_POLICY_UPDATE_RESPONSE_FAILURE",
  ...
  ADMIN_MODIFY_TEACHER_PENDING_REQUEST = "ADMIN_MODIFY_TEACHER_PENDING_REQUEST",
  ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_SUCCESS = "ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_SUCCESS",
  ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_FAILURE = "ADMIN_MODIFY_TEACHER_PENDING_RESPONSE_FAILURE",
  ...
  EVENT_OVERVIEWS_CLEAR = "EVENT_OVERVIEWS_CLEAR",
  ...
  QUESTION_RANDOM_QUESTIONS_REQUEST = "QUESTION_RANDOM_QUESTIONS_REQUEST",
  QUESTION_RANDOM_QUESTIONS_RESPONSE_SUCCESS = "QUESTION_RANDOM_QUESTIONS_RESPONSE_SUCCESS",
  QUESTION_RANDOM_QUESTIONS_RESPONSE_FAILURE = "QUESTION_RANDOM_QUESTIONS_RESPONSE_FAILURE",
  ...
  ACCOUNT_UPGRADE_SEND_REQUEST = "ACCOUNT_UPGRADE_SEND_REQUEST",
  ACCOUNT_UPGRADE_SEND_RESPONSE_SUCCESS = "ACCOUNT_UPGRADE_SEND_RESPONSE_SUCCESS",
  ACCOUNT_UPGRADE_SEND_RESPONSE_FAILURE = "ACCOUNT_UPGRADE_SEND_RESPONSE_FAILURE",
...
export const EXAM_BOARDS_CS_A_LEVEL = new Set([
  EXAM_BOARD.AQA,
  EXAM_BOARD.CIE,
  EXAM_BOARD.OCR,
  EXAM_BOARD.EDUQAS,
...
export const EXAM_BOARDS_CS_GCSE = new Set([
  EXAM_BOARD.AQA,
  EXAM_BOARD.EDEXCEL,
  EXAM_BOARD.EDUQAS,
  EXAM_BOARD.OCR,
...
export const EXAM_BOARD_ITEM_OPTIONS = Object.keys(EXAM_BOARD).map((s) => ({
  value: s,
  label: examBoardLabelMap[s as EXAM_BOARD],
}));
...
export const EMPTY_BOOLEAN_NOTATION_RECORD: { [bn in BOOLEAN_NOTATION]: false } & BooleanNotation = {
  [BOOLEAN_NOTATION.ENG]: false,
  [BOOLEAN_NOTATION.MATH]: false,
};
...
export const difficultiesOrdered: Difficulty[] = [
  "practice_1",
  "practice_2",
  "practice_3",
  "challenge_1",
...
export enum MANAGE_QUIZ_TAB {
  set = 1,
  manage = 2,
}
export enum MARKBOOK_TYPE_TAB {
  assignments = 1,
  tests = 2,
}
...
export const doughnutColours = ["#feae42", "#000000", "#e51f6f", "#ef67ac", "#bf6707", "#0f8294", "#aaaaaa", "#dbdbdb"];
...
export const hubNames: { [key in Hub]: string } = {
