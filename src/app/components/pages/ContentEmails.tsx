...
const ContentEmails = (props: ContentEmailsProps) => {
  ...
  const [overrideEnvelopeFrom, setOverrideEnvelopeFrom] = useState<
    string | undefined
  >();
  ...
  const canSubmit =
    ...
    emailTemplate?.htmlContent?.length != 0 &&
    emailTemplate?.plainTextContent?.length != 0 &&
    emailType != "null" &&
    numberOfUsers > 0;
              ...
              <React.Fragment>
                ...
                <RS.Input
                  ...
                  onClick={() => {
                    if (
                      window.confirm(
                        `Are you sure you want to send a ${emailType} email to ${numberOfUsers} user${
                          numberOfUsers > 1 ? "s" : ""
                        }?`,
                      )
                    ) {
