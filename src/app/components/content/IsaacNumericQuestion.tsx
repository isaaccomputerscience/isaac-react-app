...
const IsaacNumericQuestion = ({
  ...
  validationResponse,
  readonly,
}: IsaacQuestionProps<IsaacNumericQuestionDTO, QuantityValidationResponseDTO>) => {
                ...
                >
                  <DropdownToggle
                    ...
                    className={classNames("feedback-zone px-2 py-1", {
                      ...
                      "feedback-showing": currentAttemptUnitsWrong && noDisplayUnit,
                    })}
                  ...
                  <DropdownMenu right>
                    {selectedUnits.map((unit) => (
                      ...
                      >
                        <Markup encoding={"latex"}>{wrapUnitForSelect(unit)}</Markup>
                      </DropdownItem>
                    ))}
                  </DropdownMenu>
                </Dropdown>
