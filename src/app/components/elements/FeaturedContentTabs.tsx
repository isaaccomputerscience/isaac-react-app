...
export function FeaturedContentTabs() {
  const { data: fragment, error } = isaacApi.endpoints.getPageFragment.useQuery(
    COMPUTER_SCIENTIST_FRAGMENT_ID,
  );
            ...
            <ShowLoading
              ...
              ifNotFound={
                <div className="computer-scientist-of-the-month mt-4 mb-5 text-center">
                  Unfortunately, we don't currently have a Computer Science
                  Journey to display.
                  <br />
