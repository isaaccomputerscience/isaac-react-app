...
import { ACTION_TYPE, API_PATH, UserRole, isDefined } from "../app/services";
...
export const DAYS_AGO = (n: number, roundDownToNearestDate = false): EpochTimeStamp => {
...
export const DAYS_IN_FUTURE = (n: number, roundDownToNearestDate = false): EpochTimeStamp => {
  const d = new Date(NOW);
  d.setUTCDate(d.getUTCDate() + n);
  if (roundDownToNearestDate) d.setHours(0, 0, 0, 0);
  return d.valueOf();
