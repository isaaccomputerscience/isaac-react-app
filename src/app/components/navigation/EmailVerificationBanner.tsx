        ...
        <RS.Row style={{ alignItems: "center" }}>
          ...
          {(status == null || status == "NOT_VERIFIED") && (
            <React.Fragment>
              <RS.Col xs={12} sm={10} md={8}>
                <small>
                  Your email address is not verified - please find our email in
                  your inbox and follow the verification link. You can{" "}
                  <Button
                  ...
                  if necessary. To change your account email, go to{" "}
          ...
          {status == "DELIVERY_FAILED" && (
            <RS.Col xs={12} sm={10} md={11}>
              <small>
                One or more email(s) sent to your email address failed. This
                means you won&apos;t receive emails from Isaac, and may prevent
                you regaining access to your account. <br />
                To start receiving emails again, update your email address on
                your <Link to="/account">My account</Link> page. If you believe
                this is in error, please{" "}
                <a href={`mailto:${WEBMASTER_EMAIL}`}>email us</a>.
              </small>
            </RS.Col>
          )}
        </RS.Row>
