...
const save = function save(key: KEY, value: string) {
  try {
    ...
    console.error(
      "Failed to save to local storage. This might be a browser restriction.",
      e,
    );
    return false;
  }
...
const load = function load(key: KEY) {
  try {
    ...
    console.error(
      "Failed to read from local storage. This might be a browser restriction.",
      e,
    );
...
const remove = function remove(key: KEY) {
  try {
    ...
    console.error(
      "Failed to remove from local storage. This might be a browser restriction.",
      e,
    );
    return false;
  }
...
const pop = function pop(key: KEY) {
  try {
    ...
    console.error(
      "Failed to pop from local storage. This might be a browser restriction.",
      e,
    );
    return undefined;
  }
...
const clear = function clear() {
  try {
    ...
    console.error(
      "Failed to clear local storage. This might be a browser restriction.",
      e,
    );
    return false;
  }
...
const session = {
  save: function sessionSave(key: KEY, value: string) {
    try {
      ...
      console.error(
        "Failed to save to session storage. This might be a browser restriction.",
        e,
      );
      return false;
    }
  ...
  load: function sessionLoad(key: KEY) {
    try {
      ...
      console.error(
        "Failed to read from session storage. This might be a browser restriction.",
        e,
      );
      return LOADING_FAILURE_VALUE;
    }
  ...
  remove: function sessionRemove(key: KEY) {
    try {
      ...
      console.error(
        "Failed to remove from session storage. This might be a browser restriction.",
        e,
      );
      return false;
    }
  ...
  clear: function clear() {
    try {
      ...
      console.error(
        "Failed to clear session storage. This might be a browser restriction.",
        e,
      );
      return false;
    }
