              ...
              <CardBody>
                ...
                <Row>
                    ...
                    {event.eventThumbnail && (
                      <div className="mt-2">
                        <CardImg
                          aria-hidden={true}
                          alt={
                            "" /* Decorative image, should be hidden from screenreaders */
                          }
                  ...
                  <Col lg={8} className={event.hasExpired ? "expired" : ""}>
                          ...
                          <tr>
                            ...
                            <td>
                              {atLeastOne(event.placesAvailable) && (
                                <div>{event.placesAvailable} spaces</div>
                              )}
                              ...
                              {event.userBookingStatus === "RESERVED" && (
                                <span>
                                  ...
                                  -{" "}
                                  <span className="text-success">
                                    You have been reserved a place on this
                                    event!
                                    <Button
                              ...
                              {canBeAddedToWaitingList && (
                                <span>
                                  {" "}
                                  - {formatAvailabilityMessage(event)}
                                </span>
                              )}
                              {event.userBookingStatus === "WAITING_LIST" && (
                                <span>
                                  {" "}
                                  -{" "}
                                  {formatWaitingListBookingStatusMessage(event)}
                                </span>
                              )}
                              {event.isStudentOnly &&
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                {!event.isWithinBookingDeadline &&
                                  !event.hasExpired && (
                                    <div className="alert-danger text-center">
                                      The booking deadline for this event has
                                      passed.
                                    </div>
                                  )}
                              </td>
                    ...
                    {bookingFormOpen &&
                      user?.loggedIn &&
                      "CONFIRMED" !== event.userBookingStatus && (
                        <span>
                          <Card className="mb-4">
                            <CardBody>
                              ...
                              <Form onSubmit={submitBooking}>
                                ...
                                <div>
                                  <p className="mb-3">
                                    <small>
                                      By requesting to book on this event, you
                                      are granting event organisers access to
                                      the information provided in the form
                                      above. You are also giving them permission
                                      to set you pre-event work and view your
                                      progress. You can manage access to your
                                      progress data in your{" "}
                                      <Link
                                        to="/account#teacherconnections"
                                        target="_blank"
                                      >
                                        account settings
                                      </Link>
                                      ...
                                      .
                                      <br />
                                      If you have unsubscribed from assignment
                                      email notifications you may miss out on
                                      pre-work set for the event. You can enable
                                      this in your{" "}
                                      <Link
                                        to="/account#emailpreferences"
                                        target="_blank"
                                      >
                                        account settings
                                      </Link>
