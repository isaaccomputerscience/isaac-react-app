...
let fakeDispatch: Dispatch,
  fakeGetState,
  fakeStore: MiddlewareAPI,
  fakeNext: Dispatch<AnyAction>;
...
const checkForUserFailureAction = {
...
describe("userConsistencyCheckerMiddleware", () => {
  ...
  it("clears the current user if getting the current user fails", async () => {
    ...
    userConsistencyCheckerMiddleware(fakeStore)(fakeNext)(
      checkForUserFailureAction,
    );
