...
import { closeActiveModal, isaacApi, logAction, mutationSucceeded, openActiveModal, useAppDispatch } from "../../state";
...
const GameboardBuilder = ({ user }: { user: RegisteredUserDTO }) => {
  ...
  const pageHelp = (
    <span>
      You can create custom question sets to assign to your groups. Search by question title or topic and add up to ten
      questions to a gameboard.
      <br />
      You cannot modify a gameboard after it has been created. You&apos;ll find a link underneath any existing gameboard
      to duplicate and edit it.
    </span>
  );
      ...
      <Card className="p-3 mt-4 mb-5">
        <CardBody>
          ...
          <div className="text-center">
                ...
                createGameboard({
                  ...
                  dispatch(
                    openActiveModal({
                      ...
                      body: (
                        <GameboardCreatedModal resetBuilder={resetBuilder} gameboardId={gameboardId} error={error} />
                      ),
                    }),
                  );
                });
            ...
            >
              {isWaitingForCreateGameboard ? <Spinner size={"md"} /> : "Save gameboard"}
            </Button>
          </div>
            ...
            >
              ...
              {!isValidGameboardId(gameboardURL) && (
                <div className="text-danger">
                  The gameboard ID should contain numbers, lowercase letters, underscores and hyphens only.
                  <br />
