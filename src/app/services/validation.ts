...
const isDobOverN = (n: number, dateOfBirth?: Date | number) => {
  if (dateOfBirth !== null && dateOfBirth !== undefined) {
    ...
    const hundredAndTwentyYearsAgo = new Date(
...
export const isDobOverThirteen = (dateOfBirth?: Date | number) =>
  isDobOverN(13, dateOfBirth);
...
export const validateEmailPreferences = (
...
export function allRequiredInformationIsPresent(
  ...
  return (
    ...
    (userPreferences.EMAIL_PREFERENCE === null ||
...
export function safePercentage(
  ...
  return !(correct || correct == 0) || !attempts
    ? null
