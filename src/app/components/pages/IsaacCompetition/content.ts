export default {
  ...
  accordion: {
    ...
    video: {
      ...
      section: [
        "The competition entry should be submitted in video format of up to 5 minutes long. Any videos longer than 5 minutes will not be reviewed.",
        "Video content requirements:",
        [
          "Introduction: Introduce yourself or your team using the first names only and state the title of your project. Be creative and think about how you can make your introduction stand out!",
        ...
        "Resources:",
        [
          "Workshops: Attend any available workshops or information sessions to help refine your ideas. Check out our live booster events <a href='https://isaaccomputerscience.org/events'>here</a>.",
    ...
    termsAndConditions: {
      ...
      section: [
        ...
        "3.0 How to Enter",
        [
          "3.1. To enter the Competition: <ul><li>Teacher(s) and Student(s) register on the Isaac Computer Science platform or log in their existing account(s).</li><li>Teacher creates a group(s) on the Isaac Computer Science platform connecting the accounts of the Student(s) that are making an entry.</li><li>Student(s) works on a product concept or prototype demonstrating an IoE idea in the video format adhering to specified Entry requirements and Entry deadlines.</li><li>Teacher(s) submits a product concept or prototype demonstrating an IoE idea in the video format on behalf of a Student(s) or a group(s) of Students on the Isaac Computer Science platform.</li></ul>",
        ...
        [
          ...
          "4.3. Video content requirements: <ul><li>The video must introduce the team or an individual and give an overview of the project outlining the global problem addressed by the IoE device.</li><li>The video must describe the device and its features showcasing a design or prototype.</li><li>The video must explain how the IoE device will improve lives globally.</li><li>If a group Entry is submitted, the video must discuss the collaboration skills and methods used when working on the project. In case of an individual Entry, a Student must explain their approach when working on the project.</li></ul>",
          "4.4. Student(s) are encouraged to include additional materials to support their video submission such as: <ul><li>Diagrams, sketches, or visual representations of the IoE device.</li><li>Concise written summary of the project.</li><li>Research data or evidence supporting the feasibility and impact of the concept.</li><li>Reflections on collaboration and teamwork during the project’s development.</li></ul>",
        ...
        [
          "5.1. Finalists will be chosen from the highest scoring submissions against the following assessment criteria: <ul><li>1. Creativity and Originality: (20 points) Innovativeness of the concept and uniqueness of the idea.</li><li>2. Practicality and Feasibility: (20 points) Realistic implementation and technical feasibility.</li><li>3. Impact on Society: (30 points) Potential to improve lives globally and alignment with the theme.</li><li>4. Presentation Quality: (30 points) Clarity and organization and Engagement and communication skills.</li></ul>",
        ...
        [
          ...
          "7.2. Additional Prizes for Winners may include, but subject to change: <ul><li>£50 Amazon gift vouchers</li><li>industry tours with partners such as Siemens</li><li>A Royal Albert Hall box for a show of your choice</li><li>Isaac Computer Science notebook, pen, water bottle and stickers</li></ul>",
