...
export class CsTagService extends AbstractBaseTagService {
  private static readonly tagHierarchy = [
    TAG_LEVEL.category,
    TAG_LEVEL.subcategory,
    TAG_LEVEL.topic,
  ];
  private static readonly baseTags: BaseTag[] = [
    ...
    {
      id: TAG_ID.computerNetworks,
      title: "Computer networks",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.computerSystems,
      title: "Computer systems",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.cyberSecurity,
      title: "Cybersecurity",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.dataAndInformation,
      title: "Data and information",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.dataStructuresAndAlgorithms,
      title: "Data structures and algorithms",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.impactsOfDigitalTechnology,
      title: "Impacts of digital technology",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.machineLearningAi,
    ...
    {
      id: TAG_ID.programmingFundamentals,
      title: "Programming fundamentals",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.programmingParadigms,
      title: "Programming paradigms",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.softwareEngineering,
      title: "Software engineering",
      parent: TAG_ID.computerScience,
    },
    {
      id: TAG_ID.theoryOfComputation,
    ...
    {
      id: TAG_ID.networking,
      title: "Network fundamentals",
      parent: TAG_ID.computerNetworks,
    },
    {
      id: TAG_ID.theInternet,
      title: "The internet",
      parent: TAG_ID.computerNetworks,
    },
    {
      id: TAG_ID.networkHardware,
      title: "Network hardware",
      parent: TAG_ID.computerNetworks,
    },
    {
      id: TAG_ID.communication,
      title: "Communication",
      parent: TAG_ID.computerNetworks,
      stageOverride: GCSE_HIDDEN,
    },
    ...
    {
      id: TAG_ID.booleanLogic,
      title: "Boolean logic",
      parent: TAG_ID.computerSystems,
    },
    {
      id: TAG_ID.architecture,
      title: "Systems architecture",
      parent: TAG_ID.computerSystems,
    },
    {
      id: TAG_ID.memoryAndStorage,
    ...
    {
      id: TAG_ID.operatingSystems,
      title: "Operating systems",
      parent: TAG_ID.computerSystems,
    },
    {
      id: TAG_ID.programmingLanguages,
      title: "High- and low-level languages",
      parent: TAG_ID.computerSystems,
    },
    {
      id: TAG_ID.translators,
      title: "Translators",
      parent: TAG_ID.computerSystems,
    },
    // Cyber security topics
    {
      id: TAG_ID.socialEngineering,
      title: "Social engineering",
      parent: TAG_ID.cyberSecurity,
    },
    {
      id: TAG_ID.maliciousCode,
    ...
    {
      id: TAG_ID.numberRepresentation,
      title: "Representation of numbers",
      parent: TAG_ID.dataAndInformation,
    },
    {
      id: TAG_ID.textRepresentation,
      title: "Representation of text",
      parent: TAG_ID.dataAndInformation,
    },
    {
      id: TAG_ID.imageRepresentation,
      title: "Representation of images",
      parent: TAG_ID.dataAndInformation,
    },
    {
      id: TAG_ID.soundRepresentation,
      title: "Representation of sound",
      parent: TAG_ID.dataAndInformation,
    },
    {
      id: TAG_ID.compression,
      title: "Compression",
      parent: TAG_ID.dataAndInformation,
    },
    {
      id: TAG_ID.encryption,
      title: "Encryption",
      parent: TAG_ID.dataAndInformation,
    },
    {
    ...
    {
      id: TAG_ID.legislation,
      title: "Legislation",
      parent: TAG_ID.impactsOfDigitalTechnology,
    },
    {
      id: TAG_ID.impactsOfTech,
      title: "Impacts of technology",
      parent: TAG_ID.impactsOfDigitalTechnology,
    },
    //Machine learning topics
    {
      id: TAG_ID.graphsForAi,
      title: "Graphs to aid AI",
      parent: TAG_ID.machineLearningAi,
      hidden: true,
    },
    {
      id: TAG_ID.neuralNetworks,
      title: "Artificial neural networks",
      parent: TAG_ID.machineLearningAi,
      hidden: true,
    },
    {
      id: TAG_ID.machineLearning,
    ...
    // Maths for cs topics
    {
      id: TAG_ID.numberSystems,
      title: "Number systems and sets",
      parent: TAG_ID.mathsForCs,
    },
    {
      id: TAG_ID.mathsFunctions,
      title: "Mathematical functions",
      parent: TAG_ID.mathsForCs,
    },
    // Programming  fundamentals topics
    {
      id: TAG_ID.programmingConcepts,
      title: "Programming concepts",
      parent: TAG_ID.programmingFundamentals,
    },
    {
      id: TAG_ID.stringHandling,
      title: "String handling",
      parent: TAG_ID.programmingFundamentals,
    },
    {
      id: TAG_ID.subroutines,
      title: "Subroutines",
      parent: TAG_ID.programmingFundamentals,
    },
    {
    ...
    {
      id: TAG_ID.proceduralProgramming,
      title: "Procedural programming",
      parent: TAG_ID.programmingParadigms,
    },
    {
      id: TAG_ID.objectOrientedProgramming,
    ...
    {
      id: TAG_ID.eventDrivenProgramming,
    ...
    {
      id: TAG_ID.computationalThinking,
