    ...
    <Card>
      <CardBody>
              ...
              {isTeacherOrAbove(user) && (
                <>
                  <Button
                    ...
                    size="sm"
                    color="tertiary"
                    onClick={() => dispatch(showGroupManagersModal({ group, user }))}
                  >
        ...
        <Row className="pt-1 mb-3">
          <Col className="text-right text-muted">*Group name is shared with students</Col>
        </Row>
        {group && (
          <React.Fragment>
...
export const Groups = ({ user }: { user: RegisteredUserDTO }) => {
  ...
  const pageHelp = (
    <span>
      Use this page to manage groups. You can add users to a group by giving them the group code and asking them paste
      it into their account settings page.
      <br />
