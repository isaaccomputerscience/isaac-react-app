...
export const TeacherTools = () => {
  ...
  const achievementsSelector = useAppSelector(
    selectors.user.achievementsRecord,
  );
  ...
  const pageTitle =
    user && isTeacherOrAbove(user) ? "Teacher tools" : "How we help teachers";
                    ...
                    <ActionCard
                      ...
                      amountText={achievementText(
                        ...
                        (achievementsSelector &&
                          achievementsSelector.TEACHER_GROUPS_CREATED) ||
                          0,
                        "group",
                      )}
                    >
                  ...
                  <RS.ListGroupItem className="px-3 pt-0 pb-4 bg-transparent">
                    <ActionCard
                      ...
                      amountText={achievementText(
                        "set",
                        (achievementsSelector &&
                          achievementsSelector.TEACHER_ASSIGNMENTS_SET) ||
                          0,
                        "assignment",
                      )}
                    >
                  ...
                  <RS.ListGroupItem className="px-3 pt-0 pb-4 bg-transparent">
                    <ActionCard
                      ...
                      amountText={achievementText(
                        "created",
                        (achievementsSelector &&
                          achievementsSelector.TEACHER_GAMEBOARDS_CREATED) ||
                          0,
                        "gameboard",
                      )}
                    >
                      Create custom gameboards to set as assignments to your
                      groups.
                    </ActionCard>
                  </RS.ListGroupItem>
                </RS.ListGroup>
              ...
              <RS.Row>
                <RS.ListGroup className="mb-4 d-block d-md-flex flex-row align-items-stretch link-list bg-transparent">
                  <RS.ListGroupItem className="bg-transparent">
                    ...
                    >
                      Review your groups&apos; progress on the work which you
                  ...
                  <RS.ListGroupItem className="bg-transparent">
                    ...
                    >
                      Receive guidance on how to use isaaccomputerscience.org by
                      attending our professional development events.
                    </LinkCard>
                  </RS.ListGroupItem>
