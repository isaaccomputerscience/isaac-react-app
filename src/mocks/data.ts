...
export const buildMockStudent = <T extends number>(
  id: T extends typeof mockUser.id
    ? `Student ID cannot be the same as the mockUser: ${typeof mockUser.id}`
    : T,
) => {
  if (id === mockUser.id)
...
export const buildMockTeacher = <T extends number>(
  id: T extends typeof mockUser.id
    ? `Teacher ID cannot be the same as the mockUser: ${typeof mockUser.id}`
    : T,
) => {
  if (id === mockUser.id)
...
export const buildMockUserSummary = (
  user: any,
...
export const mockNewsPods = {
  results: [
    ...
    },
    {
      ...
      children: [],
      value:
        "Use these boards as they are, customise them, or create your own boards to meet your own needs.",
      tags: [newsPodTag],
      image: {
        type: "image",
        children: [],
