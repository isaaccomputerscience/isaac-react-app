...
module.exports = (env) => {
    ...
    return {
        ...
        devServer: {
            headers: {
                "Content-Security-Policy-Report-Only": "default-src 'self' https://cdn.isaacphysics.org https://cdn.isaaccomputerscience.org localhost:8080 ws://localhost:8080 https://maps.googleapis.com https://*.tile.openstreetmap.org https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://fast.wistia.net https://*.wistia.net https://*.wistia.com; object-src 'none'; frame-src 'self' https://editor.isaaccode.org https://anvil.works https://*.anvil.app https://www.youtube-nocookie.com https://fast.wistia.net https://*.wistia.net https://*.wistia.com; img-src 'self' localhost:8080 data: https://cdn.isaacphysics.org https://cdn.isaaccomputerscience.org https://*.google-analytics.com https://*.googletagmanager.com https://i.ytimg.com https://maps.googleapis.com https://*.tile.openstreetmap.org https://*.wistia.com https://*.wistia.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://cdn.isaacphysics.org https://cdn.isaaccomputerscience.org https://fonts.gstatic.com; connect-src 'self' localhost:8080 ws://localhost:8080 https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.wistia.com https://*.wistia.net;",
