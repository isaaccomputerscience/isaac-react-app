  ...
  return (
    <NavBar>
      <NavigationSection
        title={
          <>
            ...
            {
              <MenuBadge
                count={assignmentsCount + quizzesCount}
                message="incomplete assignments and tests"
              />
            }
          </>
        }
      >
        ...
        <LinkItem to="/tests">
          My tests{" "}
          {<MenuBadge count={quizzesCount} message="incomplete tests" />}
        </LinkItem>
      </NavigationSection>
      ...
      <NavigationSection title="Learn">
        ...
        <LinkItem to="/pages/computer_science_journeys_gallery">
      ...
      <NavigationSection title="Events">
        {isTeacherOrAbove(user) && (
          <LinkItem to="/events?show_reservations_only=true">
      ...
      {(isStaff(user) || isEventLeader(user)) && (
        <NavigationSection title="Admin">
          ...
          {isAdmin(user) && (
            <LinkItem to="/admin/usermanager">User manager</LinkItem>
          )}
          {(isEventLeader(user) || isAdminOrEventManager(user)) && (
            <LinkItem to="/admin/events">Event admin</LinkItem>
          )}
          {isStaff(user) && (
