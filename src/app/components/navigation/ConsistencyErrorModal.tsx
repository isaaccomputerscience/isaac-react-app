...
export const ConsistencyErrorModal = ({
  consistencyError,
}: {
  ...
  return (
    <RS.Modal id="user-consistency-error" isOpen={consistencyError} size={"lg"}>
      ...
      <RS.ModalBody className="px-0 mx-4">
        ...
        <p className="pb-2">
          This can happen if you have logged out or logged in as another user
          via another browser window. Please click continue to avoid any issues.
        </p>
        <p>
          <em>Note:</em>
          {
