  ...
  ({ history, location }: RouteComponentProps) => {
    ...
    const statusFilter =
      (user &&
        ...
        EventStatusFilter["My booked events"]) ||
      (user &&
        user.loggedIn &&
        query.show_reservations_only &&
        EventStatusFilter["My event reservations"]) ||
    ...
    useEffect(() => {
      ...
      dispatch(
        getEventMapData(startIndex, -1, typeFilter, statusFilter, stageFilter),
      );
      ...
      <div>
        <RS.Container>
          ...
          <div className="my-4">
              ...
              <RS.Label>
                ...
                <RS.Input
                  ...
                  onChange={(e) => {
                    ...
                    query.show_booked_only =
                      selectedFilter === EventStatusFilter["My booked events"]
                        ? true
                        : undefined;
                    query.show_reservations_only =
                      selectedFilter ===
                      EventStatusFilter["My event reservations"]
                        ...
                        : undefined;
                    query.event_status =
                      selectedFilter == EventStatusFilter["All events"]
                        ? "all"
                        : undefined;
                    history.push({
                  ...
                  {Object.entries(EventStatusFilter)
                    .filter(
                      ([statusLabel, statusValue]) =>
                        (user && user.loggedIn) ||
                        statusValue !== EventStatusFilter["My booked events"],
                    )
                    .filter(
                      ([statusLabel, statusValue]) =>
                ...
                <RS.Input
                  ...
                  onChange={(e) => {
                    ...
                    query.types =
                      selectedType !== EventTypeFilter["All events"]
                        ? selectedType
                        : undefined;
                    history.push({
                      pathname: location.pathname,
                ...
                >
                  {Object.entries(EventTypeFilter).map(
                    ([typeLabel, typeValue]) => (
                ...
                <RS.Input
                  ...
                  onChange={(e) => {
                    ...
                    query.show_stage_only =
                      selectedStage !== EventStageFilter["All stages"]
                        ? selectedStage
                        : undefined;
                    history.push({
                      pathname: location.pathname,
                ...
                <div className="my-4">
                  <RS.Row>
                    {events.map((event) => (
                      <div
                        key={event.id}
                        className="col-xs-12 col-sm-6 col-md-4 d-flex"
                      >
                  ...
                  {total === 0 && (
                    <div className="text-center">
                      <p>
                        Sorry, we cannot find any events that match your filter
                        settings.
                      </p>
                      {statusFilter ===
                        EventStatusFilter["My booked events"] && (
                        <p>
                          N.B. Events booked via Eventbrite may not appear here;
                          for these if you have received email confirmation you
                          are booked.
                        </p>
                      )}
                    </div>
            ...
            <div className="mb-5">
              <PageFragment
                fragmentId="event_type_descriptions"
