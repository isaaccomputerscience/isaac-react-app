...
import {
  atLeastOne,
  formatManageBookingActionButtonMessage,
  NOT_FOUND,
  zeroOrLess,
} from "../../../services";
...
export const AddUsersToBooking = () => {
  ...
  const userBookings = useAppSelector(
    (state: AppState) =>
      (state &&
        state.eventBookings &&
        (state.eventBookings.map(
          (b) => b.userBooked && b.userBooked.id,
        ) as number[])) ||
      [],
  );
  ...
  return (
    <Accordion
      ...
      disabled={
        ...
        "You cannot add users to a cancelled event"
      }
    >
      <RS.Form onSubmit={userSearch}>
        <RS.Row>
          <RS.Col md={6}>
            <div className="mb-3">
              <RS.Label htmlFor="user-search-familyName">
                ...
                onChange={(e) =>
                  setQueryParams(
                    Object.assign({}, queryParams, {
                      familyName: nullIfDefault(e.target.value, ""),
                    }),
                  )
                }
              />
          ...
          <RS.Col md={6}>
            <div className="mb-3">
              <RS.Label htmlFor="user-search-email">
              ...
              <RS.Input
                ...
                onChange={(e) =>
                  setQueryParams(
                    Object.assign({}, queryParams, {
                      email: nullIfDefault(e.target.value, ""),
                    }),
                  )
                }
              />
            ...
            <div className="mb-3">
              ...
              <RS.Input
                ...
                onChange={(e) =>
                  setQueryParams(
                    Object.assign({}, queryParams, {
                      role: nullIfDefault(e.target.value, "NO_ROLE"),
                    }),
                  )
                }
              >
        ...
        <RS.Row>
          <RS.Col>
            <RS.Input
              type="submit"
              className="btn btn-block btn-secondary border-0 my-2"
              value="Find user"
            />
          </RS.Col>
        </RS.Row>
                ...
                userResults.map((result) => (
                  <tr key={result.id}>
                    <td className="align-middle">
                      ...
                      {userBookings.includes(result.id as number) && (
                        <div className="text-center">Booking exists</div>
                      )}
                    </td>
                    <td className="align-middle">
