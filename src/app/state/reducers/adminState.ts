...
export const adminUserSearch = (
  adminUserSearch: AdminUserSearchState = null,
  action: Action,
) => {
  switch (action.type) {
...
export const adminUserGet = (
  adminUserGet: AdminUserGetState = null,
  action: Action,
) => {
  switch (action.type) {
...
export const adminContentErrors = (
  adminContentErrors: AdminContentErrorsState = null,
  action: Action,
) => {
  switch (action.type) {
...
export const adminStats = (
  adminSiteStats: AdminStatsState = null,
  action: Action,
) => {
  switch (action.type) {
...
export const adminEmailTemplate = (
  adminEmailTemplate: AdminEmailTemplateState = null,
  action: Action,
) => {
  switch (action.type) {
...
export type ContentVersionState = {
  liveVersion?: string;
  updateState?: ContentVersionUpdatingStatus;
  updatingVersion?: string;
} | null;
export const contentVersion = (
  contentVersion: ContentVersionState = null,
  action: Action,
): ContentVersionState => {
  switch (action.type) {
...
export const testQuestions = (
  testQuestions: TestQuestionsState = null,
  action: Action,
) => {
  switch (action.type) {
