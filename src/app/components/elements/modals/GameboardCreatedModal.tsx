...
const GameboardSuccessfullyCreated = () => (
  <Row className="mb-2">
    <Label className="mx-3">
      Your gameboard has been created. You can now set it as an assignment,
      create another board or view all of your boards.
    </Label>
  </Row>
);

const GameboardCreatedModalButtons = ({
  gameboardId,
  resetBuilder,
}: {
