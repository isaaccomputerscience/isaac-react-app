...
// export const COMPETITION_END_DATE = new Date("2026-08-28T23:59:59Z"); // UTC timezone
export const COMPETITION_END_DATE = new Date("2026-07-28T23:59:59Z"); // UTC timezone

//The Entries closed banner will be displayed till midnight on 13 Mar 2026.
export const ENTRIES_CLOSED_BANNER_END_DATE = new Date("2026-12-13T23:59:59Z"); // UTC timezone
