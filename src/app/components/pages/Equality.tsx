    ...
    const _updateEquation = (pycode: string) => {
      ...
      debounceTimer.current = window.setTimeout(() => {
        ...
        if (
          ...
          (isError(parsedExpression) || (parsedExpression.length === 0 && pycode !== ""))
        ) {
        ...
        <Container>
          ...
          <Row>
            <Col md={{ size: 2 }} className="py-4 syntax-picker mode-picker">
              <div>
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditorMode(e.target.value as EditorMode)}
                >
            ...
            <Col md={{ size: 8 }} className="py-4 question-panel">
              {(editorMode === "maths" || (isStaff(user) && editorMode === "logic")) && (
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: previewText
                      ...
                      : `<small>${editorMode === "maths" ? "or c" : "C"}lick here to enter a formula</small>`,
                  }}
                />
                {modalVisible && (
                  <InequalityModal
          ...
          {currentAttemptValue && currentAttemptValue.result && currentAttemptValue.result.tex && (
            <Row>
