...
export const sortOnPredicateAndReverse =
  (predicate: string, reverse: boolean) => (a: object, b: object) => {
...
export function sortByNumberStringValue<T>(
  field: keyof T,
...
export function sortByStringValue<T>(
  field: keyof T,
  undefinedFirst: boolean = false,
) {
  return function comparator(a: T, b: T) {
