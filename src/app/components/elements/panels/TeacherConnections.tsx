                      ...
                      activeAuthorisations.map((teacherAuthorisation) => (
                        <React.Fragment key={teacherAuthorisation.id}>
                          <li>
                            ...
                            >
                              This user ({teacherAuthorisation.email}) has
                              access to your data. To remove this access, click
                              &apos;Revoke&apos;.
                            </RS.UncontrolledTooltip>
                            <RS.Button
                              color="link"
              ...
              <RS.Row>
                <RS.Col lg={7}>
                  <h3>
                    ...
                    >
                      These are the students who have shared their Isaac data
                      with you. These students are also able to view your name
                      and email address on their Teacher connections page.
                    </RS.UncontrolledTooltip>
                  </h3>
                  <p>
                ...
                <RS.Col lg={5}>
                  <div className="connect-list">
                    <h3>
                      <span className="icon-person-active" /> Student
                      connections{" "}
                    </h3>
                        ...
                        {studentAuthorisations &&
                          studentAuthorisations.map((student) => (
                            <li key={student.id}>
                              ...
                              >
                                You have access to this user&apos;s data and
                                they can see your name and email address. To
          ...
          <RS.Row>
            <RS.Col>
              ...
              <p>
                ...
                leaving a group. While you are inactive in a group you
                won&apos;t receive any assignments from that group. If you want
                to permanently leave a group, ask your teacher to remove you.
              </p>
                          ...
                          <td>
                            {membership.membershipStatus ===
                              ...
                              <React.Fragment>
                                ...
                                >
                                  If you leave a group you will no longer
                                  receive notifications of new assignments.
                                </RS.UncontrolledTooltip>
                              </React.Fragment>
                            )}
