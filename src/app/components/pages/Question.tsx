...
interface QuestionPageProps
  extends RouteComponentProps<{ questionId: string }> {
  questionIdOverride?: string;
  match: match & { params: { questionId: string } };
}

export const Question = withRouter(
  ({ questionIdOverride, match, location }: QuestionPageProps) => {
    ...
    return (
      <ShowLoading
        ...
        thenRender={(supertypedDoc) => {
          ...
          const isFastTrack =
            doc && doc.type === DOCUMENT_TYPE.FAST_TRACK_QUESTION;
              ...
              <GameboardContext.Provider value={navigation.currentGameboard}>
                <Container>
                  ...
                  <TitleAndBreadcrumb
                    ...
                    audienceViews={determineAudienceViews(
                      doc.audience,
                      navigation.creationContext,
                    )}
                  >
                    {isFastTrack &&
                      fastTrackProgressEnabledBoards.includes(
                        gameboardId || "",
                      ) && (
                      ...
                      {doc.supersededBy && isStudent(user) && (
                        <div className="alert alert-warning">
                          ...
                          <RS.Button
                            ...
                            onClick={() =>
                              dispatch(goToSupersededByQuestion(doc))
                            }
                          >
                            has been replaced
                          </RS.Button>
                          .<br />
                          However, if you were assigned this version, you should
                          complete it.
                        </div>
                      )}
