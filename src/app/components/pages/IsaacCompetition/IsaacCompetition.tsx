...
export const IsaacCompetition = () => {
  ...
  const accordionSections = [
    ...
    { id: "1", title: accordion.video.title, section: accordion.video.section },
    ...
    { id: "4", title: accordion.availableSupport.title, section: accordion.availableSupport.section },
