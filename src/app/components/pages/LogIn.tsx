...
export const useLoginLogic = () => {
  ...
  const totpChallengePending = useAppSelector(
    (state: AppState) => state?.totpChallengePending,
  );
    ...
    <>
      ...
      <FormGroup>
        ...
        <FormFeedback id="verification-code-validation-message">
          {isNaN(Number(mfaVerificationCode)) &&
        ...
        <Button
          ...
          onClick={(event) => {
            ...
            if (mfaVerificationCode)
              dispatch(
                submitTotpChallengeResponse(mfaVerificationCode, rememberMe),
              );
          }}
        />
      </FormGroup>
