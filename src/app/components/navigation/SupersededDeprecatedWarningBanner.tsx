...
export function SupersededDeprecatedWarningBanner({
  doc,
}: {
  doc: ContentDTO;
}) {
        ...
        <div className="text-left">
          {supersededBy && (
            <>
              ...
              <br />
              If this question appears on one of your gameboards, you may want
              to update the gameboard.
              <br />
              You can find help for this at Help and support &gt; Teacher
              Support &gt; Assigning Work.
              <br />
              <br />
              Students will not see this message, but will see a smaller note at
              the bottom of the page.{doc.deprecated && <br />}
            </>
          )}
          {doc.deprecated && (
            <>
              As this {contentType} is unsupported, we do not recommend using it
              with your students.
            </>
          )}
        </div>
