...
export const TrackedRoute = function ({
  component,
  trackingOptions,
  componentProps,
  ...rest
  ...
  if (component) {
        ...
        <Route
          ...
          render={(props) => {
            ...
            const userNeedsToBeTutorOrTeacher =
              rest.ifUser &&
              [isTutorOrAbove.name, isTeacherOrAbove.name].includes(
                rest.ifUser.name,
              ); // TODO we should try to find a more robust way than this
            return (
    ...
    throw new Error(
      "TrackedRoute only works on components, got: " + JSON.stringify(rest),
    );
  }
};
