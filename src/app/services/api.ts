...
export const api = {
  ...
  questions: {
    ...
    randomQuestions: (): AxiosPromise<ApiTypes.IsaacQuestionPageDTO[]> => {
      return endpoint.get("/questions/random");
    },
  },
  concepts: {
  ...
  events: {
    ...
    getEventOverviews: (
      ...
      const params = { limit: 30, start_index: startIndex };
  ...
  eventBookings: {
    ...
    reserveUsersOnCompetition: (eventId: string, userIds: number[], submissionLink: string, groupName: string, projectTitle: string) => {
