...
export const ShareLink = ({
  ...
  const csUrlOrigin =
    segueEnvironment !== "DEV" ? "https://isaaccs.org" : window.location.origin;
  ...
  useOutsideCallback(
    shareLinkDivRef,
    () => clickAwayClose && setShowShareLink(false),
    [setShowShareLink],
  );
  ...
  return (
    <div ref={shareLinkDivRef} className="share-link-icon">
      <button
      ...
      <div
        className={`share-link ${showShareLink ? "d-block" : ""} ${
          showDuplicateAndEdit ? "double-height" : ""
        }`}
